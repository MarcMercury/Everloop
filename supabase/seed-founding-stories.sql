...
('l0000001-0001-0001-0001-000000000001', 'Drelmere', 'A small town that becomes the site of the Bell Tree''s appearance. Features a town square where the mysterious tree materializes.', 'Central Realm', 'settlement', 'First location where a Bell Tree manifested in recent memory. Site of the Second Shard discovery.', ARRAY['Town Square', 'The Gorge', 'Underground Cavern'], TRUE),
('l0000001-0001-0001-0001-000000000002', 'Watcher''s Hill', 'A lonely hill where the hermit Eidon lives, overlooking the surrounding lands. He watches for signs of the Fray from this vantage point.', 'Near Drelmere', 'hill', 'Home of Eidon the Folder, a place of observation and ancient knowledge.', ARRAY['Eidon''s Dwelling', 'Observation Point'], TRUE),
('l0000001-0001-0001-0001-000000000003', 'Uncle Edran''s Home', 'The humble dwelling where the three siblings were raised by their Uncle Edran before setting out on their journey.', 'Rural Outskirts', 'homestead', 'Starting point of the siblings'' journey.', ARRAY['Family Home', 'Workshop'], TRUE),
('l0000001-0001-0001-0001-000000000004', 'The Sacred Cavern', 'An underground chamber beneath Drelmere containing 22 spirals and bells that must be rung in sequence to reveal the Second Shard.', 'Beneath Drelmere', 'underground', 'Location of the Second Shard. Accessible only through a riddle entrance.', ARRAY['22 Spirals', 'Bell Sequence Puzzle', 'Shard Chamber'], TRUE);
...
('a0000001-0001-0001-0001-000000000001', 'l0000001-0001-0001-0001-000000000001'),
('a0000001-0001-0001-0001-000000000001', 'l0000001-0001-0001-0001-000000000002'),
('a0000001-0001-0001-0001-000000000001', 'l0000001-0001-0001-0001-000000000003'),
('a0000001-0001-0001-0001-000000000001', 'l0000001-0001-0001-0001-000000000004')
ON CONFLICT DO NOTHING;

-- Link Story 2 locations
INSERT INTO story_locations (story_id, location_id) VALUES
('a0000001-0001-0001-0001-000000000002', 'l0000001-0001-0001-0002-000000000001'),
('a0000001-0001-0001-0001-000000000002', 'l0000001-0001-0001-0002-000000000002'),
('a0000001-0001-0001-0001-000000000002', 'l0000001-0001-0001-0002-000000000003'),
('a0000001-0001-0001-0001-000000000002', 'l0000001-0001-0001-0002-000000000004')
ON CONFLICT DO NOTHING;

-- Link Story 3 locations
INSERT INTO story_locations (story_id, location_id) VALUES
('a0000001-0001-0001-0001-000000000003', 'l0000001-0001-0001-0003-000000000001'),
('a0000001-0001-0001-0001-000000000003', 'l0000001-0001-0001-0003-000000000002'),
('a0000001-0001-0001-0001-000000000003', 'l0000001-0001-0001-0003-000000000003')
ON CONFLICT DO NOTHING;

-- Link Story 4 locations
INSERT INTO story_locations (story_id, location_id) VALUES
('a0000001-0001-0001-0001-000000000004', 'l0000001-0001-0001-0004-000000000001'),
('a0000001-0001-0001-0001-000000000004', 'l0000001-0001-0001-0004-000000000002'),
('a0000001-0001-0001-0001-000000000004', 'l0000001-0001-0001-0004-000000000003'),
('a0000001-0001-0001-0001-000000000004', 'l0000001-0001-0001-0004-000000000004')
ON CONFLICT DO NOTHING;
